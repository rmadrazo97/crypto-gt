...
const TermsAndConditions = () => {
  return (
    <div className="termsAndConditions">
      <h1 className="termsAndConditions-heading">Términos y Políticas</h1>
      <p className="termsAndConditions-brief-txt">
      ...
      <div className="termsAndConditions-inner">
        <p>
          ...
          <br />
          <br />
          Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et
          nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet,
